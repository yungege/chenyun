...
class Image{
     ...
     */
    public function __construct($type = self::IMAGE_IMAGICK, $imgname = null){
        /* 判断调用库的类型 */
        switch ($type) {
            case self::IMAGE_GD:
                $class = 'Image_Gd';
     ...
     * @return Object          当前图片处理库对象
     */
    public function water($locate = self::IMAGE_WATER_SOUTHEAST, $alpha=40, $source = "/image/shuiyin.png"){
     ...
     * @return Object          当前图片处理库对象
     */
    public function text($text, $size, $font = "/verify/ttfs/1.ttf", $color = '#00000000', 
